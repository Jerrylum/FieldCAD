...
def add_handler(
    event: adsk.core.Event, callback: Callable, *, name: Optional[str] = None, local_handlers: Optional[list] = None
):
...
def _define_handler(handler_type, callback, name: Optional[str] = None):
